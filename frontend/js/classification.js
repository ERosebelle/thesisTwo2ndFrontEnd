...
function updateClassification(data){
    ...
    if(!data){
        ...
        console.log(
            "No classification data received"
        );
...
if(summaryBox){
    ...
    summaryBox.addEventListener(
        ...
        ()=>{
            ...
            if(
                window.SummaryCard &&
                typeof window.SummaryCard.open === "function"
            ){
    ...
    function(event){
        ...
        if(
            event.target.closest("#summaryBox")
        ){
