...
const energyThumb = document.getElementById(
    "energyThumb"
);
...
// ACCEPT BUTTON
// =========================
// Uses location.replace() instead of location.href so that
// consent.html is REMOVED from browser history rather than
// just sitting there as a previous entry. Once accepted,
...
// Ensures this page can never be instantly
...
// Once consent has been accepted, this
...
// so returning here (e.g. via Back) always re-runs the check above
