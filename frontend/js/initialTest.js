...
const informationData = {
    ...
    process: {
        ...
        <li>Only the generated password representationis retained for analysis.</li>
    ...
    analysis: {
        ...
        <p>The system checks password structures and patterns
        without storing the original password. </p>
        <ul>
    ...
    methods: {
        ...
        <br>
        Attempts commonly used words, phrases, and known password patterns. </li>
    ...
    tutorial: {
        ...
        <div class="tutorial-container">
            <p> Step 3: Review the vulnerability result and recommended actions.</p>
    ...
    scanButton.addEventListener("click",
        async () => {
            ...
            try {
                ...
                console.log("Initial Test Backend Response:", result);

                // SAVE BACKEND RESULT
                sessionStorage.setItem("analysisResult", JSON.stringify(result));

                /* SAVE PASSWORD FOR RESULT.JS */
                localStorage.setItem("analyzedPassword", password);
...
/* INITIAL PAGE PROTECTION - Prevent leaving Initial Test using browser Back/Forward buttons.
...
that do not re-run scripts and therefore would not be caught by the popstate handler above.*/
window.addEventListener(
    "pageshow",
    function (event) {
        if (event.persisted) {
